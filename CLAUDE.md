!!! This file is generated by concatenating .claude/CLAUDE-1-Common.md, .claude/CLAUDE-2-Project.md, and .claude/CLAUDE-3-Launcher.md. If you have to update it, update the corresponding source file(s) as well.
...
## Regenerating CLAUDE.md / AGENTS.md

The project's `CLAUDE.md` and `AGENTS.md` are generated by concatenating the
`.claude/CLAUDE-N-*.md` parts. After editing any of those parts, regenerate
both files with:
